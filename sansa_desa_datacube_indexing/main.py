...
def process_spot_dataset(
    ...
    with rasterio.open(psh_dataset) as ds:
        ...
        rendered = template.render(
            ...
            coord2_y=int(geo_interface_mapping["coordinates"][0][1][1]),
            coord3_x=int(geo_interface_mapping["coordinates"][0][2][0]),
            coord3_y=int(geo_interface_mapping["coordinates"][0][2][1]),
            coord4_x=int(geo_interface_mapping["coordinates"][0][3][0]),
            coord4_y=int(geo_interface_mapping["coordinates"][0][3][1]),
            shape_x=ds.shape[0],
            shape_y=ds.shape[1],
